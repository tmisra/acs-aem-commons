 ...
 * </pre>
 * 
 * This example will override the normal actionUri of `$exceptionHandler`, to make angular
 ...
 * interface for interacting with an object that represents the result of an actionUri that is
 ...
 *
 * @description
 * Modifies the default behavior of the html A tag so that the default actionUri is prevented when
 * the href attribute is empty.
 *
 * This change permits the easy creation of actionUri links with the `ngClick` directive
 ...
 *
 *
 * # Submitting a form and preventing the default actionUri
 *
 ...
 *
 * For this reason, Angular prevents the default actionUri (form submission to the server) unless the
 * `<form>` element has an `actionUri` attribute specified.
 *
        ...
        return {
          pre: function(scope, formElement, attr, controller) {
            if (!attr.action) {
              ...
              // actionUri is not prevented. see #1238
              //
              ...
              // way that will achieve the prevention of the default actionUri.
 ...
 *
 * Additionally it prevents the default actionUri (which for form means sending the request to the
 * server and reloading the current page) **but only if the form does not contain an `actionUri`
 * attribute**.
 *
 * @element form
